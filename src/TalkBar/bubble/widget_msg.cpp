...
WidgetMsg::WidgetMsg(QWidget *parent) : QWidget(parent)
{
...
//    te_font.setLetterSpacing(QFont::AbsoluteSpacing, 0);             //设置字间距为3像素 //设置字间距像素值
    ...
    m_leftPixmap = QPixmap(":/Icons/MainWindow/head.png");
    m_rightPixmap = QPixmap(":/Icons/MainWindow/head2.png");

    m_loadingMovie = new QMovie(this);
    m_loadingMovie->setFileName(":/Icons/MainWindow/loading.gif");
...
void WidgetMsg::setText(QString text, QString time, QSize allSize, WidgetMsg::User_Type userType)
{
    m_msg = text;
    m_userType = userType;
    m_time = time;
...
QSize WidgetMsg::fontRect(QString str)
{
    m_msg = str;
    int minHei = 30;
    int iconWH = 40;
...
QSize WidgetMsg::getRealString(QString src)
{
...
void WidgetMsg::paintEvent(QPaintEvent *event)
{
    Q_UNUSED(event);
