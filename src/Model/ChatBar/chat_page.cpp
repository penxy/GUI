...
ChatPage::ChatPage(Core *core, QWidget *parent) : QWidget(parent), m_core(core){
 ...
 */
void ChatPage::SlotListChangeIdx(Type::Info::Identity identity, int idx){
    if(m_type == Type::Info::Identity::Friend){
